...
val peopleModule = module {
  viewModel { PeopleListViewModel(get(), get(), get(), get(), get(), get()) }
  viewModel { PersonDetailViewModel(get(), get(), get(), get(), get(), get(), get()) }
  viewModel { PersonCreateEditViewModel(get(), get(), get(), get(), get(), get(), get(), get()) }
}
